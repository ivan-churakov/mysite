    ...
    return (
        <div className='w-full h-96 relative'>
            <div className='container mx-auto h-full relative'>
                <div
                    className="w-[calc(100% - 8rem)] z-10 absolute top-1/2 translate-y-[-50%] left-0 flex flex-row items-center gap-20 p-8 mx-8 bg-white/10 backdrop-blur-md rounded-xl">
            ...
            <img src={bg} className='z-0 w-full h-full object-cover absolute top-0'/>
        </div>
    );
};